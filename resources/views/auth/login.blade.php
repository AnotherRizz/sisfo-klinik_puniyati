...
<body class="font-poppins bg-gray-100">
    ...
    <main class="w-full md:max-w-3xl mx-auto mt-20 p-4 bg-white shadow-lg rounded-xl">
        <h1 class="text-3xl font-bold text-gray-800 mb-4 text-center uppercase">Portal sistem rekam medis elektronik
            Bidan Praktik Mandiri</h1>
    ...
    @if (session('login_attempts') >= 3)
        <form id="resetPasswordForm" method="POST" action="{{ route('password.reset.default') }}"
            style="display: none;">
            @csrf
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    title: 'Login Gagal!',
                    text: 'Anda sudah gagal login 3 kali. Ingin reset password ke default?',
                    icon: 'warning',
