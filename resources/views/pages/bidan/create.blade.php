   ...
   <form action="{{ route('bidan.store') }}" method="POST">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" id="no_telp" name="no_telp" value="{{ old('no_telp') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required />
        </div>
    </div>
