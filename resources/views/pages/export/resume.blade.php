...
<body>
    ...
    <table class="bordered">
        ...
        <tr>
            <td class="left">LILA (Cm)</td>
            <td>{{ $pemeriksaan->lila }}</td>
        </tr>
        <tr>
            <td class="left">Pemeriksaan Ibu Hamil</td>
            <td>{{ $pemeriksaan->pemeriksaan_ibu_hamil }}</td>
        </tr>
        <tr>
            <td class="left">Pemeriksaan Ibu Nifas/KB</td>
            <td>{{ $pemeriksaan->pemeriksaan_ibu_nifas_kb }}</td>
        </tr>
        <tr>
