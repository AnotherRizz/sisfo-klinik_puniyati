    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <div class="flex justify-start items-center mb-4">
                <h2 class="text-base font-semibold uppercase">Laporan Data Pemeriksaan {{ $jenisPelayanan }} Periode
                    {{ $namaBulan }}</h2>
            </div>
                ...
                <table class="min-w-full text-xs text-left border border-gray-300 whitespace-normal break-words">
                    <thead class="bg-gray-100 text-gray-700">
                        <tr>
                            ...
                            <th class="border px-2 py-1 text-center">SATURASI OX </th>
                            <th class="border px-2 py-1 text-center">PEMERIKSAAN PENUNJANG</th>
                    ...
                    <tbody>
                        @foreach ($pemeriksaans as $index => $item)
                            ...
                            <tr class="border-b">
                                ...
                                <td class="border px-2 py-1">{{ $item->saturasiOx ?? '-' }}</td>
                                <td class="border px-2 py-1">{{ $item->pemeriksaan_penunjang ?? '-' }}</td>
