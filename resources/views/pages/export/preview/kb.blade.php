                ...
                <table class="min-w-full text-xs text-left border border-gray-300 whitespace-normal break-words">
                    <thead class="bg-gray-100 text-gray-700">
                        <tr>
                            ...
                            <th class="border px-2 py-1 text-center">METODE KB </th>
                            <th class="border px-2 py-1 text-center">TANGGAL PASANG KB </th>
                    ...
                    <tbody>
                        @foreach ($pemeriksaans as $index => $item)
                            ...
                            <tr class="border-b">
                                ...
                                <td class="border px-2 py-1">{{ $item->jmlhanak ?? '-' }}</td>
                                <td class="border px-2 py-1">{{ $item->alergi ?? '-' }}</td>
                              ...
                              <td class="border px-2 py-1">  {{ \Carbon\Carbon::parse($item->hpht)->translatedFormat('d/m/Y') ?? '-' }}</td>
                                <td class="border px-2 py-1">{{ $item->metode_kb ?? '-' }}</td>
                                 <td class="border px-2 py-1">  {{ \Carbon\Carbon::parse($item->tglpasang)->translatedFormat('d/m/Y') ?? '-' }}</td>
