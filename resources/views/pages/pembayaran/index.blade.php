            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($pembayarans as $item)
                    <tr
                        ...
                        <td class="px-4 py-2 text-sm text-gray-900">{{ $item->pemeriksaan->pendaftaran->pasien->nama_pasien ?? '-' }}</td>
                        <td class="px-4 py-2 text-sm text-gray-900">{{ $item->pemeriksaan->pendaftaran->bidan->nama_bidan ?? '-' }}</td>
