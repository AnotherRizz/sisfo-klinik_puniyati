...
@section('content')
    <h1 class="text-xl font-semibold mb-4">Tambah Data Pemeriksaan Kesehatan ANAK</h1>
    <div class="mb-6">
    ...
    <div class="p-7 bg-white rounded shadow">
        ...
        <form action="{{ route('kia-anak.store') }}" method="POST">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2">
                ...
                {{-- No Registrasi --}}
                <div>
                    <x-select2 id="pendaftaran_id" name="pendaftaran_id" label="No Registrasi(pelayanan Kesehatan Anak)"
