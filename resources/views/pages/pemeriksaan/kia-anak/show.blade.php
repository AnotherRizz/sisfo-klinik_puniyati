...
@section('content')
    ...
    {{-- Informasi Umum --}}
    <h2 class="text-lg font-semibold text-sky-500 mb-4 flex gap-2 items-center">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
        ...
        <x-detail-card label="Panjang Badan (PB)" :value="$pemeriksaan->pb ? $pemeriksaan->pb . ' Cm' : '-'" />
        <x-detail-card label="Lingkar Kepala (LK)" :value="$pemeriksaan->lk ? $pemeriksaan->lk . ' Cm' : '-'" />
    </div>

    {{-- Keluhan dan Diagnosa --}}
    <h2 class="text-lg font-semibold text-purple-500 flex gap-2 items-center mt-8 mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{-- Obat --}}
    <h2 class="text-lg font-semibold text-teal-500 flex gap-2 items-center mt-8 mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <h2 class="text-lg font-semibold text-amber-500 flex gap-2 items-center mt-8 mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
        <x-detail-card label="Tindak Lanjut"
            :value="$pemeriksaan->tindak_lnjt ? (($pemerik_
