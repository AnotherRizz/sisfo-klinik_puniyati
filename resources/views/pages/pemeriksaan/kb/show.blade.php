        ...
        <div class="bg-white shadow-md rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                ...
                <x-detail-card label="Hari Pertama Haid Ibu Hamil" :value="$pemeriksaan->hpht
                    ...
                    : '-'"  />
                <x-detail-card label="Jumlah Anak Hidup" :value="$pemeriksaan->jmlh_anak ?? '-'" />
                <x-detail-card label="Tanggal Pasang Fundus" :value="$pemeriksaan->tgl_pasang
                    ? \Carbon\Carbon::parse($pemeriksaan->tgl_pasang)->translatedFormat('d F Y')
                    : '-'" />
